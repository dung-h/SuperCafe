...
define('MESSENGER_WEBHOOK_RATE_LIMIT_MAX', (int)(getenv('MESSENGER_WEBHOOK_RATE_LIMIT_MAX') ?: 20));
define('MESSENGER_WEBHOOK_RATE_LIMIT_WINDOW_SEC', (int)(getenv('MESSENGER_WEBHOOK_RATE_LIMIT_WINDOW_SEC') ?: 10));
define('EXTERNAL_SESSION_SECRET', getenv('EXTERNAL_SESSION_SECRET') ?: '');
define('BOT_DEFAULT_SHIPPING_VND', (int)(getenv('BOT_DEFAULT_SHIPPING_VND') ?: 30000));
define('BOT_SHOP_LAT', (float)(getenv('BOT_SHOP_LAT') ?: 10.772081646838936));
define('BOT_SHOP_LNG', (float)(getenv('BOT_SHOP_LNG') ?: 106.65817769618629));
define('BOT_DELIVERY_BASE_ETA_MINUTES', (int)(getenv('BOT_DELIVERY_BASE_ETA_MINUTES') ?: 20));
define('BOT_DELIVERY_PER_KM_ETA_MINUTES', (int)(getenv('BOT_DELIVERY_PER_KM_ETA_MINUTES') ?: 4));
define('BOT_DELIVERY_FALLBACK_ETA_MINUTES', (int)(getenv('BOT_DELIVERY_FALLBACK_ETA_MINUTES') ?: 45));
